...
llama_tokenzier_root = plugin_dir + "llama/tokenizer.model" 
caption_anno_path = f'../data/nuscenes/tod3/final_caption_bbox_token.json'
load_from = "projects/work_dirs/train_base2/epoch_14.pth"
...
map_num_vec = 100
map_fixed_ptsnum_per_gt_line = 1 # now only support fixed_pts > 0
...
model = dict(
    ...
    caption_head=dict(
        ...
        tod3_ratio=0.4*(1 if with_tod3 else 0),
        caption_ratio=0.6,
        iou_threshold = 0.25,
        pc_range=point_cloud_range,
    ...
    freeze_module_list = ['img_backbone', 'img_neck', 'pts_bbox_head'],
    freeze_bn = True,
...
ann_root = './data/infos/'
map_root = './data/nuscenes/map_anns/'
ann_file_train = ann_root + f"nuscenes_infos_0605_train.pkl"
ann_file_val = ann_root + f"nuscenes_infos_0605_val.pkl"
ann_file_test = ann_root + f"nuscenes_infos_0605_val.pkl"
...
train_pipeline = [
    ...
    dict(type="LoadCaption", tokenizer_path=llama_tokenzier_root, caption_anno_path=caption_anno_path),
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs',
               'ego_fut_trajs', 'ego_fut_masks', 'ego_fut_cmd', 'ego_lcf_feat',
               'gt_attr_labels', "gt_caption_token", "gt_caplabel", "gt_capmask", 
               "ins_list", "tod3_centers",])
]
        ...
        transforms=[
            ...
            dict(type='CustomCollect3D',\
                 keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'fut_valid_flag',
                       ...
                       'ego_lcf_feat', 'gt_attr_labels', "gt_caption_token", "gt_caplabel",
                       "gt_capmask", "ins_list", "tod3_centers"])])
]
...
data = dict(
    ...
    val=dict(type=dataset_type,
             ...
             map_classes=map_classes,
             map_ann_file=map_root + 'nuscenes_map_anns_val.json',
             map_fixed_ptsnum_per_line=map_fixed_ptsnum_per_gt_line,
             map_eval_use_same_gt_sample_num_flag=map_eval_use_same_gt_sample_num_flag,
             use_pkl_result=True,
             caption=with_caption,
