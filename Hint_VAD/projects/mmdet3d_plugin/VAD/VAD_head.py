...
class VADHead(DETRHead):
    ...
    def loss_single(self,
        ...
        return loss_cls, loss_bbox, loss_traj, loss_traj_cls, isnotnan
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, loss_traj, loss_traj_cls, notnan_idx = multi_apply(
    ...
    def get_bboxes(self, preds_dicts, img_metas, rescale=False):
        ...
        det_preds_dicts, idx_mask  = self.bbox_coder.decode(preds_dicts)
