...
mode = 'val'
pkl_path = f'data/infos/nuscenes_infos_capQA_{mode}.pkl'
command_path = 'data/nuscenes/video_cap/commands.json'
output_path = f'data/infos/nuscenes_infos_capQAcmd_{mode}.pkl'
