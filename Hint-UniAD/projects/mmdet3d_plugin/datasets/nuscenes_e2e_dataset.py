...
import projects.mmdet3d_plugin.datasets.eval_utils.score_caption as score_caption
import json
...
class NuScenesE2EDataset(NuScenesDataset):
    ...
    def __init__(self,
                 ...
                 samples_per_gpu=1, # only for validation
        ...
        self.QA = QA[0]
        self.command = command[0] # kding
        self.DriveLM = DriveLM[0]
        self.tod3 = tod3[0] # modi
    ...
    def evaluate(self,
        ...
        if 'caption' in self.eval_mod:
            ...
            score_caption.score_caption(osp.join(out_dir, 'caption', 'caption_results.json'))
    ...
    def _evaluate_single(self,
        ...
        if 'motion' in self.eval_mod:
            ...
            self.nusc_eval_motion.main(
                ...
                render_curves=False,
                eval_mode='standard')
            print('evaluate motion mAP-minFDE metrics...') # modified
            self.nusc_eval_motion.main(
                plot_examples=0,
                render_curves=False,
                eval_mode='motion_map')
