...
class ObjectRangeFilterTrack(object):
    ...
    def __call__(self, input_dict):
        ...
        # tod3_tokens = input_dict['tod3_tokens']
        ...
        # tod3_tokens = [token for token, m in zip(tod3_tokens, mask) if m] # Kding
        ...
        # input_dict['tod3_tokens'] = tod3_tokens # Kding
        # print("len(input_dict['tod3_tokens']) in pipeline: ", len(input_dict['tod3_tokens']))
        # print("len(input_dict['gt_inds']) in pipeline: ", len(input_dict['gt_inds']))
        return input_dict
